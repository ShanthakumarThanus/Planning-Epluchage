            ...
            <?php foreach ($weeks as $index => $week): ?>
                ...
                <td>
                    ...
                    <?php foreach ($users as $user): ?>
                        <option value="<?php echo htmlspecialchars($user['username']); ?>" <?php if ($selectedUser == $user['username']) echo 'selected'; ?>>
                            <?php echo htmlspecialchars($user['username']); ?> <!-- Affichage du nom d'utilisateur -->
                        </option>
                    <?php endforeach; ?>
                    </select>
                </td>
